...
import tywin from './images/tywin.jpg'
import cercie from './images/cercie.jpg'
import night from './images/night.jpg'
import joff from './images/joff.jpg'
import ramsey from './images/ramsey.jpg'
...
const App= () => {
  ...
  const checkForRowOfFour = () => {
    for(let i=0;i<64;i++){
      ...
      const decidedColor = currentColorArrangement[i];
      const notValid = [5,6,7,13,14,15,21,22,23,29,30,31,37,38,39,45,53,46,47,54,55,62,63,64];
